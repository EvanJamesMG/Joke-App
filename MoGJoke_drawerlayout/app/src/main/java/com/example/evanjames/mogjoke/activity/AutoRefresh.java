 ...
 */
public class AutoRefresh extends SwipeRefreshLayout implements AbsListView.OnScrollListener{
    /**
     * 滑动到最下面时的上拉操作
     */
     ...
     * @param context
     */
    public AutoRefresh(Context context) {
        this(context, null);
    }

    public AutoRefresh(Context context, AttributeSet attrs) {
        super(context, attrs);
